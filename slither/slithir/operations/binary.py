...
class Binary(OperationWithLValue):
    ...
    def __init__(self, result, left_variable, right_variable, operation_type):
        ...
        self._lvalue = result
        if BinaryType.return_bool(operation_type):  #本文件第31行
    ...
    def __str__(self):
        ...
        # if (self.variable_right._name == 'block.timestamp' or self.variable_right._name == 'now') and (self.type_str in ['>', '>=', '<', '<=', '==']):
        #
        ...
        #                                     #"RightValue"
        #                                     )
        # if (self.variable_left._name == 'block.timestamp' or self.variable_left._name == 'now')and (self.type_str in ['>', '>=', '<', '<=', '==']):
        #     return '{}({}) = {} {} {}'.format(str(self.lvalue),
        #                                     self.lvalue.type,
        #                                     self.variable_left,
        #                                     #"LeftValue",
