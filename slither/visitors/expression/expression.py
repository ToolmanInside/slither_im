...
class ExpressionVisitor:
    ...
    def __init__(self, expression):
        ...
        self._result = None
        self._visit_expression(self.expression)  # self.expression:return self._expression;self._visit_expression本文件37行
    ...
    def _visit_expression(self, expression):
        ...
        '''
          if isinstance(expression, AssignmentOperation):
                self._pre_assignement_operation(expression)#pass
        '''
        ...
        '''
        if isinstance(expression, AssignmentOperation):
            self._post_assignement_operation(expression)  #pass
        '''
    ...
    def _visit_call_expression(self, expression):
        self._visit_expression(expression.called)#msg.sender.call.value(amount)()
